   ...
   public static class Builder {
      ...
      public Builder left(int left){
         for (int i = 0; i < left; i++) {
            this.instructionsBuilder.append(Key.LEFT.getAsChar());
         }
         return this;
      }
      ...
      public Builder right(int right){
         for (int i = 0; i < right; i++) {
            this.instructionsBuilder.append(Key.RIGHT.getAsChar());
         }
         return this;
      ...
      public Builder up(int up){
         for (int i = 0; i < up; i++) {
            this.instructionsBuilder.append(Key.UP.getAsChar());
         }
         return this;
      ...
      public Builder down(int down){
         for (int i = 0; i < down; i++) {
            this.instructionsBuilder.append(Key.DOWN.getAsChar());
         }
         return this;
